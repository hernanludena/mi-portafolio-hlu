...
const dictionary = {
    es: {
        ...
        "skills.cat.designInfra": "Diseño & Infra",
        "skills.cat.tools": "Herramientas",
        "skills.cat.architecture": "Arquitectura & Liderazgo",
    ...
    en: {
        ...
        "skills.cat.designInfra": "Design & Infra",
        "skills.cat.tools": "Tools",
        "skills.cat.architecture": "Architecture & Leadership",
